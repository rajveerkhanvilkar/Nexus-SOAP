export const CLINICAL_DICTIONARY = {
  ...
  DISEASES: {
    ...
    GASTRO: ["Gastritis", "GERD", "IBS", "Diarrhea", "Constipation", "Peptic Ulcer", "Acidity", "Julab", "Ultya", "Amoebiasis", "Gas", "Badhazmi", "Pet Safa", "Bawaseer", "Piles"],
    ORTHO: ["Arthritis", "Spondylitis", "Fracture", "Back Pain", "Sciatica", "Osteoporosis", "Kambar Dukhne", "Sande Dukhi", "Stiffness", "Gathiya", "Moch"],
    DERMA: ["Eczema", "Psoriasis", "Dermatitis", "Acne", "Fungal Infection", "Rash", "Khaj", "Khandu", "Khajli", "Phunsi"],
    NEURO: ["Migraine", "Vertigo", "Stroke", "Lakwa", "Epilepsy", "Seizures", "Chakkar", "Mirgi", "Fit"],
    ENT: ["Otitis", "Tonsillitis", "Sinusitis", "Ear Pain", "Throat Infection", "Gala Kharash", "Kan Dukhne"],
  ...
  MEDICINES: {
    ...
    PAINKILLERS: ["Paracetamol", "Ibuprofen", "Diclofenac", "Naproxen", "Tramadol", "Combiflam", "Aceclofenac", "Voveran", "Dolo 650", "Calpol", "Ultracet", "Spasmo-Proxyvon", "Saridon", "Disprin", "Crocin"],
    ...
    TOPICAL: ["Moov", "Volini", "Iodex", "Boroline", "Betadine"]
  },
  SYMPTOMS: [
